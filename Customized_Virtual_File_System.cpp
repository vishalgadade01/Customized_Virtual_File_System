...
void man(char *name)
{
    ...
    else if(strcmp(name,"rm") == 0)
    {
         ...
         printf("Usage:rm File_name mode\n");
    }
    else
    {
...
void DisplayHelp()
{
    ...
    printf("stat: To Diaplay information of filesusing name\n");
...
int CreateFile(char *name, int permission)
{
    ...
    if (temp == NULL) // Check if there was an available inode
        return -4;
    ...
    if (i == 50) // Check if there is an available slot in UFDTArr
        return -5;

    UFDTArr[i].ptrfiletable = (PFILETABLE)malloc(sizeof(FILETABLE)); // Allocate memory for file table
    if (UFDTArr[i].ptrfiletable == NULL)
        return -6;
    ...
    if (UFDTArr[i].ptrfiletable->ptrinode->Buffer == NULL) // Check if memory allocation for buffer was successful
    {
        free(UFDTArr[i].ptrfiletable); // Free the allocated memory for file table
        return -7;
    }

    SUPERBLOCKobj.FreeInodes--; // Decrement the free inodes count only after successful creation
...
void ls_file()
{
    ...
    printf("\nFilename\tInode number\tFileSize\tLink Count\n");
    printf("------------------------------------------------\n");
    while(temp !=  NULL)
    {
        if(temp->FileType != 0)
...
int main()
{
    ...
    while(1)
    {
       ...
       if(count == 1)
       {
         ...
         else if(strcmp(command[0],"clear") == 0)
         {
          ...
          {
             printf("Terminiting the Virtual System\n");
             break;
          }
          else
          {
    ...
    else if(count == 4)
    {
        if(strcmp(command[0],"lseek")== 0)
        {
             ...
             if(ret == -1)
             {
                printf("ERROR : Uable to perform lseek!!!\n");
             }
        }
        else
        {
...
/*
OUTPUT:
C:\Users\visha\OneDrive\Desktop\LB\DataStructure\project2>a.exe
DILB created successfully

VFS: > create Demo.txt 3
...
VFS: > exit
Terminiting the Virtual System

C:\Users\visha\OneDrive\Desktop\LB\DataStructure\project2>
*/